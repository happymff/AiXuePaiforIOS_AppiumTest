 ...
 */
public class TeacherSendPaperAndTest {
    ...
    public void pushTest() throws Exception {
        ...
        //输入账号和密码
        driverios.findElement(By.className("UIATextField")).clear();
        ...
        driverios.findElement(By.className("UIASecureTextField")).clear();
        ...
        Thread.sleep(5000);//课件刷新
            System.out.println("~~~~~~~~~~~~~~第" + (i + 1) + "次推送课件~~~~~~~~~~~~~~~~~~~~~~");
            if ((i % 2) == 0) {
                //判断是否已自动化测试需要下载
                if (i == 0) {
...
//                }
            ...
            driverios.findElementByAccessibilityId("navbar menu default").click();
            Thread.sleep(3000);
            driverios.findElementByAccessibilityId("电子白板").click();
            driverios.findElementByAccessibilityId("navbar menu default").click();
            driverios.findElementByAccessibilityId("推送").click();
            System.out.println("~~~~~~~~~~~~~~~~~~~~~第" + (i +1) + "次推送白板~~~~~~~~~~~~~~~~~~~~~~~~~");
            Thread.sleep(5000);
            driverios.findElementByAccessibilityId("结束推送").click();
            Thread.sleep(5000);
            System.out.println("结束推送啦~~");
        }
    }
