 ...
 */
public class BaiBanRecordingMoreLineTest {
...
// initializing explicit wait object
    ...
    @Test
    public void recordMoreLineTest1(String username, String pwd) throws Exception {
        ...
        Thread.sleep(3000);
            if (j==0) {
                ...
                selectSpecialFigure.selectSpecialFigure("line");
            }
            for (int i = 0; i < 5; i++) {
