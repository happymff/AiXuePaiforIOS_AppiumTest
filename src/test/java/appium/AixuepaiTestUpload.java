...
public class AixuepaiTestUpload extends AppiumDriverBase {
    ...
    public void ellipseTest(String username, String pwd) throws Exception {
        ...
        driver.findElement(By.id("com.etiantian.pclass:id/lftm_btn_folder")).click();
        driver.findElement(By.id("com.etiantian.pclass:id/ligf_card")).click();
        driver.findElement(By.id("com.etiantian.pclass:id/lfmf_btn_edit")).click();
        driver.findElement(By.id("com.etiantian.pclass:id/lfmf_btn_all")).click();
        driver.findElement(By.id("com.etiantian.pclass:id/lfmf_btn_upload")).click();
        ...
        for (int i = 0; i < 3; i++) {
            ...
            driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
            TouchAction dragNDrop = new TouchAction(driver);
            dragNDrop.longPress(width/2, height*4/5).moveTo(width/2, height/5).release().perform();
        }
       List<AndroidElement> list = driver.findElements(By.id("com.etiantian.pclass:id/ligcw_base"));
       String s1 = list.get(14).findElement(By.id("com.etiantian.pclass:id/view_uploaded")).getText();
        Thread.sleep(120000);
        Assert.assertEquals("已上传",s1);
    }
